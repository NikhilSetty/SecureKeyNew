...
public class DbTableStrings {
 ...
 public  static final String TABLE_NAME_AUTHENTICATION="authentication";
    ...
    public static final String DATA_URI="content://com.phoenix.securekey.SecureProvider/data";
    public static final String VAULT_URI = "content://com.phoenix.securekey.SecureProvider/vault";
    public static final String AUTH_URI="content://com.phoenix.securekey.SecureProvider/authentication";
